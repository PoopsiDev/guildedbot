...
class BotClient extends guilded_js_1.Client {
    constructor(options, autoInit = true) {
        ...
        this.monitors = new collection_1.Collection();
    ...
    loadFile(result, dir, collection) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (cmd) {
                if (!cmd.subcommands)
                    cmd.subcommands = new collection_1.Collection();
    ...
    cooldownReached(message, command, options) {
        return message.reply(`You must wait **${this.humanizeMilliseconds(options.cooldown.timestamp - options.now)}** before using the *${command.fullName}* command again.`);
    }
}
