...
exports.MessageCollectorMonitor = void 0;
const Monitor_1 = require("../structures/Monitor");
class MessageCollectorMonitor extends Monitor_1.Monitor {
    execute(message) {
...
exports.MessageCollectorMonitor = MessageCollectorMonitor;
exports.default = MessageCollectorMonitor;
